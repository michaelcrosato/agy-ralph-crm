...
- **E2E Testing:** No dedicated web `Playwright` configuration is currently committed in this repo section. Add explicit `playwright` configs when new UI E2E coverage is required.
