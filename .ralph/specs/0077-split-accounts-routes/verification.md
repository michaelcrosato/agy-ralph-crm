# Spec 077 Verification Strategy
...
This commands will run the Biome checks, compilation gates, unit tests, and diagnostics to ensure the entire workspace is healthy.
